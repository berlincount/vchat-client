...
/* config-option   type    name in file  default value           value       localvar  */
  ...
  // TODO: {CF_FINGERPRINT, CO_STR, "fingerprint","~/.vchat/fingerprint", NULL,       { NULL }  },
  // TODO: {CF_ENCODING,    CO_STR, "encoding",   NULL,                   NULL,       { .pstr = &encoding }},
  ...
  // TODO: {CF_USECERT,     CO_INT, "usecert",    (char *) 1,             (char *)-1, { NULL }  },
  ...
  // TODO: {CF_SCROLLBPRIV, CO_INT, "privscrollb",(char *) 2048,          (char *)-1, { NULL }  },
  // TODO: {CF_SCROLLBACK,  CO_INT, "scrollback", (char *) 8192,          (char *)-1, { NULL }  },
  // TODO: {CF_SCROLLBPRIVT,CO_INT, "privscrollt",(char *) 0,             (char *)-1, { NULL }  },
  // TODO: {CF_SCROLLBACKT, CO_INT, "scrolltime", (char *) 86400,         (char *)-1, { NULL }  },
...
/* format-string    string */
  ...
  // TODO: FE( FS_PRIV,         "%s"),
  FE( FS_SERV,         "\0012%s"),
  // TODO: FE( FS_GLOB,         "\0012%s"),
  FE( FS_DBG,          "\0013%s"),
  FE( FS_ERR,          "\0011%s"),
  // TODO: FE( FS_ERR_STRING,   "\0011%s %s"),
  FE( FS_IDLE,         "\0018%s"),
  ...
  // TODO: FE( FS_BGPRIVMSG,    "\0011! Bogus message, not sent."),
  FE( FS_PUBACTION,    "\0015*\0010 \0016%s\0010 %s"),
  FE( FS_TXPUBACTION,  "\0015*\0010 \0016\001b%s\001B\0010 %s"),
  FE( FS_TXPUBTHOUGHT, ".o( %s )"),
  FE( FS_TXPUBNTHOUGHT,".oO( %s )"),
  FE( FS_PUBTHOUGHT,   "\0015*\0010 \0016\001b%s\001B\0010 %s"),
  // TODO: FE( FS_BGTXPUBACTION,"\0011! No action taken."),
  FE( FS_COMMAND,      "\0012## command: %s"),
  // TODO: FE( FS_LOCALCOMMAND, "\0012## local command (not executed yet): %s"),
  // TODO: FE( FS_BOGUSCOMMAND, "\0012## bogus command (not executed or sent): %s"),
  FE( FS_SBINF,        " [%d/%d] "),
  // TODO: FE( FS_MISSTYPED,    "\0011* Probably misstyped? Not sent: %s"),
  // TODO: FE( FS_UNKNCMD,      "\0011* Unknown client command: %s"),
  // TODO: FE( FS_BADREGEX,     "\0011* Could not compile regex: %s"),
  FE( FS_PLAIN,        NULL)
};
