...
CF_LOGINSCRIPT, CF_USESSL, CF_IGNSSL, CF_VERIFYSSL, CF_PRIVHEIGHT,
CF_PRIVCOLLAPS, CF_HSCROLL, CF_CHANNEL, CF_USETOPIC, CF_BELLPRIV,
CF_AUTORECONN, CF_USETIME, CF_CASEFIRST, CF_KEEPALIVE,
/* TODO: CF_FINGERPRINT, CF_USECERT, CF_SCROLLBPRIV, CF_SCROLLBACK,
 * CF_SCROLLBPRIVT, CF_SCROLLBACKT, CF_ENCODING, */
} confopt;

/* format strings */
typedef enum { FS_PLAIN, FS_SERV, FS_DBG, FS_ERR, FS_IDLE, FS_TIME, FS_CONSOLETIME,
FS_TOPICW, FS_NOTOPICW, FS_CONSOLE, FS_CONNECTED, FS_CANTCONNECT, FS_TOPIC,
...
FS_MYPUBURL, FS_RXPUBMSG, FS_MYPUBMSG, FS_TXPUBMSG, FS_RXPRIVMSG,
FS_TXPRIVMSG, FS_PUBTHOUGHT, FS_TXPUBTHOUGHT, FS_TXPUBNTHOUGHT,
FS_PUBACTION, FS_TXPUBACTION, FS_COMMAND, FS_SBINF,
/* TODO: FS_CHAN, FS_PRIV, FS_GLOB, FS_BGPRIVMSG, FS_BGTXPUBACTION,
 * FS_LOCALCOMMAND, FS_BOGUSCOMMAND, FS_MISSTYPED, FS_UNKNCMD, FS_BADREGEX,
 * FS_ERR_STRING */
} formtstr;
